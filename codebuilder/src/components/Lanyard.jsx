 ...
 * @param {Array} gravity - Physics gravity [x, y, z]
 * @param {Number} fov - Field of view
 * @param {Boolean} transparent - Canvas transparency
 */
...
/**
 * Band Component - Handles the lanyard physics and visuals
 */
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
  ...
  // Vector utilities for calculations
  ...
  // Initialize Catmull-Rom curve for smooth band rendering
  ...
  // Create rope joints connecting segments
  ...
  useFrame((state, delta) => {
    ...
    // Update band curve and physics
    if (fixed.current) {
      // Lerp mid-joints for smooth motion
      [j1, j2].forEach(ref => {
  ...
  return (
    <>
      {/* Lanyard anchor and joints */}
      <group position={[6.5, 6.5, -2]}>
        {/* Fixed anchor point */}
